...
class Home extends Component {
  constructor (props) {
    ...
    this.state.langKey = this.props.match.params.lang || 'en'
    if (!this.langs[this.state.langKey]) {
      this.props.history.push('/')
    }
    // if (typeof navigator !== 'undefined') {
    //   this.state.langKey = window.localStorage.lang || navigator.language.split('-')[0]
    // }
  }
      ...
      <Wrapper>
        <div className='intro'>
          <SectionBar>
            ...
            {this.showLanguage && <LanguagePicker langs={this.langs} langKey={this.state.langKey} onSelect={this.onLanguage.bind(this)} />}
